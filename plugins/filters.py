    ...
    if 2 < len(message.text) < 50:    
        ...
        if len(btn) > 10: 
            ...
            await message.reply_text(
                f"<b> ʜᴇʀᴇ ɪs ᴛʜᴇ ʀᴇsᴜʟᴛ ғᴏʀ {message.text}</b>",
    ...
    if (clicked == typed) or (clicked in AUTH_USERS):
        ...
        if query.data.startswith("next"):
            ...
            keyboard = InlineKeyboardMarkup([
                ...
                [InlineKeyboardButton("🅙︎🅞︎🅘︎🅝︎ 🅞︎🅤︎🅡︎ 🅒︎🅗︎🅐︎🅝︎🅝︎🅔︎🅛︎", url="https://t.me/SCProjectsLK")]
            ])
            ...
            keyboard = InlineKeyboardMarkup([
                [InlineKeyboardButton("🅑︎🅐︎🅒︎🅚︎", callback_data="start_data"),
                    InlineKeyboardButton("🅐︎🅑︎🅞︎🅤︎🅣︎", callback_data="about_data")],
                [InlineKeyboardButton("🅢︎🅤︎🅟︎🅟︎🅞︎🅡︎🅣︎", url="https://t.me/SCProjectsLK_Chat")]
            ])
            ...
            keyboard = InlineKeyboardMarkup([
                ...
                [InlineKeyboardButton("👨‍💻 🅓︎🅔︎🅥︎", url="https://t.me/SCProjectsLK")]
            ])
